...
public partial class Maze {
    ...
    public void Level004 () {
        ...
        moves = new List<int>() { 8, 16, 64, 64, 64 };
        ...
        CreateCell (new IntVector3 (1, 2), 1);
        CreateCell (new IntVector3 (2, 2), 4);
        CreateCell (new IntVector3 (3, 2), 16);
        CreateCell (new IntVector3 (4, 2), 4);
        CreateCell (new IntVector3 (5, 2), 2);
        ...
        CreateCell (new IntVector3 (2, 4), 4);
        CreateCell (new IntVector3 (3, 4), 4);
        CreateCell (new IntVector3 (4, 4), 4);
        CreateCell (new IntVector3 (5, 4), 4);
